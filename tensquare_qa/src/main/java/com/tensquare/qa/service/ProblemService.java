...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> findNewRecommendList(String labelid,int page ,int size){
		//1.创建分页对象
		PageRequest pageRequest = PageRequest.of(page-1,size);
		//2.获取结果集并返回
	 ...
	 * @return
	 */
	public Page<Problem> findHotRecommendList(String labelid,int page,int size){
		//1.创建分页对象
		PageRequest pageRequest = PageRequest.of(page-1,size);
		//2.获取结果集并返回
	 ...
	 * @return
	 */
	public Page<Problem> findWaitRecommendList(String labelid,int page,int size){
		//1.创建分页对象
		PageRequest pageRequest = PageRequest.of(page-1,size);
		//2.获取结果集并返回
